...
- [_FluentHandler_](../src/Monolog/Handler/FluentHandler.php): Logs records to a [Fluentd](http://www.fluentd.org/) account.
...
- [_FluentdFormatter_](../src/Monolog/Formatter/FluentdFormatter.php): Used to format log records to [Fluentd](http://www.fluentd.org/) messages.
